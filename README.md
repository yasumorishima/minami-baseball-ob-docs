...
| Metric | Count |
|--------|-------|
| TypeScript/TSX files | <!--stat:ts_files-->147<!--/stat--> |
| Lines of code | <!--stat:loc-->~16800<!--/stat--> |
| Page routes | <!--stat:pages-->43<!--/stat--> |
| API routes | <!--stat:apis-->12<!--/stat--> |
| Reusable components | <!--stat:components-->51<!--/stat--> |
